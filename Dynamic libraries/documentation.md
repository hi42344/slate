...
- ```coroutine_set_return_value(co, v)``` // Sets the return value for a suspended coroutine. ```Returns 1 on success, or 0 if the coroutine is invalid or not suspended```
